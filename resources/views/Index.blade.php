                  ...
                  <div class="pb-2">
                    ...
                    before:top-[60px] before:rounded before:z-[-1] before:bg-opacity-[0.1] before:bg-info-500">
                        <div class="  h-[70px] w-[70px] rounded-full mx-auto mb-4 relative">
                          ...
                          <img src="{{asset("images/all-img/cus-1.png")}}" alt="" class="w-full h-full rounded-full">
                    ...
                    before:top-[60px] before:rounded before:z-[-1] before:bg-opacity-[0.1] before:bg-warning-500">
                        <div class="  ring-2 ring-[#FFC155]  h-[70px] w-[70px] rounded-full mx-auto mb-4 relative">
                          ...
                          <img src="{{asset("images/all-img/cus-2.png")}}" alt="" class="w-full h-full rounded-full">
                          <span class="h-[27px] w-[27px] absolute right-0 bottom-0 rounded-full bg-[#FFC155] border border-white flex flex-col
                            items-center justify-center text-white text-xs font-medium">
                            1
                          </span>
                    ...
                    before:top-[60px] before:rounded before:z-[-1] before:bg-opacity-[0.1] before:bg-success-500">
                        <div class="  h-[70px] w-[70px] rounded-full mx-auto mb-4 relative">
                          ...
                          <img src="{{asset("images/all-img/cus-3.png")}}" alt="" class="w-full h-full rounded-full">
                          <span class="h-[27px] w-[27px] absolute right-0 bottom-0 rounded-full bg-[#FFC155] border border-white flex flex-col
                            items-center justify-center text-white text-xs font-medium">
                            3
                          </span>
                  ...
                  <div class="grid md:grid-cols-3 grid-cols-1 gap-5">
                    ...
                    <div class="bg-slate-50 dark:bg-slate-900 p-4 rounded text-center">
                      <div class="h-12 w-12 rounded-full mb-4 mx-auto">
                        <img src="{{asset("images/all-img/p-1.png")}}" alt="" class="w-full h-full rounded-full">
                      </div>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-900 p-4 rounded text-center">
                      <div class="h-12 w-12 rounded-full mb-4 mx-auto">
                        <img src="{{asset("images/all-img/p-2.png")}}" alt="" class="w-full h-full rounded-full">
                      </div>
                      <span class="text-slate-500 dark:text-slate-300 text-sm mb-1 block font-normal">
                        $150.00
                      </span>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-900 p-4 rounded text-center">
                      <div class="h-12 w-12 rounded-full mb-4 mx-auto">
                        <img src="{{asset("images/all-img/p-3.png")}}" alt="" class="w-full h-full rounded-full">
                      </div>
                      <span class="text-slate-500 dark:text-slate-300 text-sm mb-1 block font-normal">
                        $150.00
                      </span>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-900 p-4 rounded text-center">
                      <div class="h-12 w-12 rounded-full mb-4 mx-auto">
                        <img src="{{asset("images/all-img/p-4.png")}}" alt="" class="w-full h-full rounded-full">
                      </div>
                      <span class="text-slate-500 dark:text-slate-300 text-sm mb-1 block font-normal">
                        $150.00
                      </span>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-900 p-4 rounded text-center">
                      <div class="h-12 w-12 rounded-full mb-4 mx-auto">
                        <img src="{{asset("images/all-img/p-5.png")}}" alt="" class="w-full h-full rounded-full">
                      </div>
                      <span class="text-slate-500 dark:text-slate-300 text-sm mb-1 block font-normal">
                        $150.00
                      </span>
                    ...
                    <div class="bg-slate-50 dark:bg-slate-900 p-4 rounded text-center">
                      <div class="h-12 w-12 rounded-full mb-4 mx-auto">
                        <img src="{{asset("images/all-img/p-6.png")}}" alt="" class="w-full h-full rounded-full">
                      </div>
                      <span class="text-slate-500 dark:text-slate-300 text-sm mb-1 block font-normal">
                        $150.00
                      </span>
  ...
  document.addEventListener("DOMContentLoaded", function() {
        var options = {
            ...
            xaxis: {
                ...
                labels: {
                    style: { fontFamily: "Inter", colors: "#475569" }
                },
            },

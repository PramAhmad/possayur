                ...
                <div class="space-y-3">
                    ...
                    <div class="text-sm space-y-2">
                        ...
                        <div>
                            ...
                            <p class="text-slate-500 dark:text-slate-300">{{ Carbon\Carbon::parse($suratJalan->due_date)->translatedFormat('d F Y') }}</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table class="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-medium text-slate-500 dark:text-slate-300 uppercase tracking-wider">Quantity</th>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-slate-500 dark:text-slate-300 uppercase tracking-wider">Price</th>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-slate-500 dark:text-slate-300 uppercase tracking-wider">Total</th>
                            ...
                            <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                                ...
                                <tr>
                                    <td class="px-4 py-3 text-sm text-slate-500 dark:text-slate-300">{{ $product->product->name }}</td>
                                    <td class="px-4 py-3 text-sm text-slate-500 dark:text-slate-300">{{ $product->qty }}</td>
                                    <td class="px-4 py-3 text-sm text-slate-500 dark:text-slate-300">{{ number_format($product->unit_price,0, ',', '.') }}</td>
                                    <td class="px-4 py-3 text-sm text-slate-500 dark:text-slate-300">{{ number_format($product->total_price,0, ',', '.') }}</td>
                                </tr> 
                                @endforeach
                            </tbody>
                        </table>

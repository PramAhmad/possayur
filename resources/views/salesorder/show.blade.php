            ...
            <div class="absolute left-5 top-3 px-2 py-2 rounded-full bg-cyan-500 text-white">
                ...
                <div class="h-full overflow-hidden mt-4">
                    <div class="h-full overflow-y-auto px-2">
                        ...
                        <div class="grid grid-cols-5 gap-4 pb-3">
            ...
            <div class="w-5/12 flex flex-col bg-blue-gray-50 h-full bg-white pr-4 pl-2 py-4">
                <div class="bg-white rounded-3xl flex flex-col h-full shadow">
                    ...
                    <div id="cart-items" class="flex-1 flex flex-col overflow-auto" style="display:none;">
                        <div class="h-16 text-center flex justify-center">
                            <div class="pl-8 text-left text-lg py-4 relative">
                                ...
                                <div id="cart-count" class="text-center absolute bg-cyan-500 text-white w-5 h-5 text-xs p-0 leading-5 rounded-full -right-2 top-3"></div>
                            </div>
                    ...
                    <div class="flex flex-col bg-white rounded-3xl  p-4 mt-4">
                        ...
                        <select id="customer" name="customer" class="w-fulll text-lg font-semibold text-blue-gray-700 bg-white border-2 border-gray-200 rounded-lg focus:bg-white focus:shadow-lg py-3 px-2 focus:outline-none">
                        ...
                        <div class="mb-3 text-blue-gray-700 px-3 pt-2 pb-3 rounded-lg bg-blue-gray-50">
                            <div class="flex text-lg font-semibold">
                                ...
                                <div class="flex text-right">
                                    ...
                                    <input id="cash" type="text" class="w-28 text-right bg-white shadow rounded-lg focus:bg-white focus:shadow-lg px-2 focus:outline-none">
                                </div>
                            </div>
                            <hr class="my-2">
                            <div class="grid grid-cols-3 gap-2 mt-2">
                                <!-- Payment buttons will be dynamically loaded here -->
                            </div>
                        </div>
                        <div id="change-info" class="flex mb-3 text-lg font-semibold bg-cyan-50 text-blue-gray-700 rounded-lg py-2 px-3" style="display:none;">
                            <div class="text-cyan-800">CHANGE</div>
                            <div id="change-amount" class="text-right flex-grow text-cyan-600"></div>
                        </div>
                        <div id="error-info" class="flex mb-3 text-lg font-semibold bg-pink-100 text-blue-gray-700 rounded-lg py-2 px-3" style="display:none;">
                            <div id="error-message" class="text-right flex-grow text-pink-600"></div>
                        </div>
                        <button id="submit-payment" class="text-white rounded-2xl text-lg w-full py-3 focus:outline-none bg-cyan-500 hover:bg-cyan-600">
                            SUBMIT
                        </button>
                    </div>
                    <!-- end of payment info -->
        ...
        <div id="modalReceipt" class="fixed w-full h-screen left-0 top-0 z-10 flex flex-wrap justify-center content-center p-24" style="display: none;">
            ...
            <div class="w-96 rounded-3xl bg-white shadow-xl overflow-hidden z-10">
                ...
                <div class="p-4 w-full">
                    <button id="proceedButton" class="bg-cyan-500 text-white text-lg px-4 py-3 rounded-2xl w-full focus:outline-none">PROCEED</button>
                </div>
            </div>
        </div>

           ...
           <div class="mb-5">
                ...
                <div class="lg:flex justify-between flex-wrap items-center mb-6">
                  ...
                  <div class="flex lg:justify-end items-center flex-wrap space-xy-5">
                    <a href="{{route('salesorder.pdf',['id'=>$salesOrder->id])}}" class="invocie-btn inline-flex btn btn-sm whitespace-nowrap space-x-1 cursor-pointer bg-white dark:bg-slate-800

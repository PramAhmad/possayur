                        ...
                        <form class="space-y-4" method="post" action="{{ route('supplier.store') }}">
                            ...
                            <div class="grid md:grid-cols-2 gap-7">
                                <div class="input-area">
                                    ...
                                    <input id="phone" name="phone" type="text" class="form-control" placeholder="Masukkan Nomor Telepon">
                                    @error('phone')
                                    <div class="text-red-500 mt-2 text-sm">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="grid md:grid-cols-2 gap-7">
                                <div class="input-area">
                                    ...
                                    <input id="company" name="company" type="text" class="form-control" placeholder="Masukkan Nama Perusahaan">
                                    @error('company')
                                    <div class="text-red-500 mt-2 text-sm">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="shop_name" name="shop_name" type="text" class="form-control" placeholder="Masukkan Nama Toko">
                                    @error('shop_name')
                                    <div class="text-red-500 mt-2 text-sm">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="grid md:grid-cols-2 gap-7">
                                <div class="input-area">
                                    ...
                                    <input id="bank_name" name="bank_name" type="text" class="form-control" placeholder="Masukkan Nama Bank">
                                    @error('bank_name')
                                    <div class="text-red-500 mt-2 text-sm">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="bank_branch" name="bank_branch" type="text" class="form-control" placeholder="Masukkan Cabang Bank">
                                    @error('bank_branch')
                                    <div class="text-red-500 mt-2 text-sm">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="grid md:grid-cols-2 gap-7">
                                <div class="input-area">
                                    ...
                                    <input id="account_holder" name="account_holder" type="text" class="form-control" placeholder="Masukkan Nama Pemegang Rekening">
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="account_number" name="account_number" type="text" class="form-control" placeholder="Masukkan Nomor Rekening">

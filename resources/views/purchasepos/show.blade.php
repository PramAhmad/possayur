   ...
   $(document).ready(function() {
    ...
    $("#clear-cart").click(function() {
        ...
        $("#submit-payment").click(function() {
            ...
            if (supplier === "") {
                $("#error-message").text("supplier harus diisi!");
                $("#error-info").show();
                $("#change-info").hide();
                return;
            }
      ...
      `;
        ...
        $("#proceedButton").click(function() {
            ...
            $("#modalReceipt").fadeOut();
            const item = JSON.parse(localStorage.getItem('pochart')) || [];
            const cash = parseInt($("#cash").val()) || 0;
                            ...
                            <div>
                                <div role="button"
                                    ...
                                    <div class="flex pb-3 px-3 text-sm mt-3">
                                        ...
                                        <p class="nowrap font-semibold">Rp ${new Intl.NumberFormat().format(product.cost_price)}</p>
                                    </div>
                                </div>
                            </div>
                        `;

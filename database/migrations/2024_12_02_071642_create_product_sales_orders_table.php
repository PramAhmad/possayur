...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('product_sales_orders', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('variant_id')->nullable()->index('product_sales_orders_variant_id_foreign');
            $table->unsignedBigInteger('batch_id')->nullable()->index('product_sales_orders_batch_id_foreign');
            $table->integer('qty');
